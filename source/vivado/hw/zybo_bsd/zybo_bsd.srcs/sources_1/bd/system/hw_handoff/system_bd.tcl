...
CONFIG.CONST_WIDTH {6} \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myLED_0/S_AXI/S_AXI_reg] SEG_myLED_0_S_AXI_reg
